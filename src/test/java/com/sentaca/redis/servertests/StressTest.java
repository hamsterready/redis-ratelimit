...
/***
 * This test i susefull to see how the redis-ratelimit work. It requires
 * a redis server on the local machine running.
 * 
 * @author witek
 * 
 */
...
public class StressTest extends TestCase {
  ...
  public void test() {
    ...
    int tpsInterval = 10;
    TestServer server = new TestServer(allowedTps, bucketSpan, bucketInterval, tpsInterval);
